 ...
 * minor edits by Paul Stoffregen, 2011, to support different serial ports
 *
...
//////////////////////////////////////////////////////////////////////
//
// This section configures which serial port will be used by default.
// You can override this by using setSerial() instead of begin(),
// or just edit the code below to configure which port begin() uses.
//
//////////////////////////////////////////////////////////////////////
...
XBee::XBee(): _response(XBeeResponse()), xbeeSerial(DEFAULT_SERIAL) {
	_pos = 0;
	_escape = false;
	_checksumTotal = 0;
	_nextFrameId = 0;
...
void XBee::begin(long baud) {
	DEFAULT_SERIAL.begin(baud);
	xbeeSerial = DEFAULT_SERIAL;
}
