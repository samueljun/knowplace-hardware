...
This example uses the SoftwareSerial library to view the XBee communication.  I am using a 
Modern Device USB BUB board (http://moderndevice.com/connect) and viewing the output
with the Arduino Serial Monitor.    
You can obtain the SoftwareSerial library here http://arduiniana.org/libraries/NewSoftSerial/
*/
